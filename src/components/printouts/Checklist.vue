...
export default {
  ...
  computed: {
    ...
    ready() {
      return this.patientInfo && this.user;
    },
  },
  data() {
    return {
  ...
  methods: {
                ...
                table: {
                  ...
                  body: [
                    [
                      { text: "ID:", border: [] },
                      {
                        text: this.patientInfo["Student Number"],
    ...
    formatBody() {
      ...
      if (
        this.patientInfo.Type === "Employee/Faculty" &&
        this.patientInfo.Location === "Caloocan"
      ) {
        body.push([
          {
            text: "STOOL",
